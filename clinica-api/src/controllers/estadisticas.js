    ...
    try {
      ...
      generarPdf(res, {
        ...
        columnas: [
          ...
          { titulo: 'Atendidos',    clave: 'turnos_atendidos',    ancho: 75, align: 'right' },
          { titulo: 'Pendientes',   clave: 'turnos_pendientes',   ancho: 75, align: 'right' },
          { titulo: 'Ingresos',     clave: 'ingresos_realizados', ancho: 120, align: 'right' },
          { titulo: '% Atención',   clave: 'porcentaje_atencion', ancho: 80, align: 'right' },
        ],
        filas,
      });
    } catch (err) {
    ...
    try {
      ...
      generarPdf(res, {
        ...
        columnas: [
          ...
          { titulo: 'Médicos',      clave: 'total_medicos',       ancho: 65, align: 'right' },
          { titulo: 'Total',        clave: 'total_turnos',        ancho: 75, align: 'right' },
          { titulo: 'Atendidos',    clave: 'turnos_atendidos',    ancho: 75, align: 'right' },
          { titulo: 'Pendientes',   clave: 'turnos_pendientes',   ancho: 75, align: 'right' },
          { titulo: 'Ingresos',     clave: 'ingresos_realizados', ancho: 120, align: 'right' },
  ...
  async resumenGeneralPdf(req, res) {
    try {
      ...
      const filas = [
        ...
        { indicador: 'Ingresos Realizados',       valor: fmt.dinero(data.ingresos_realizados) },
        { indicador: 'Porcentaje de Atención',    valor: fmt.pct(data.porcentaje_atencion) },
        { indicador: 'Pacientes con Turnos',      valor: data.total_pacientes },
        { indicador: 'Médicos con Actividad',     valor: data.total_medicos },
        { indicador: 'Obras Sociales con Turnos', valor: data.total_obras_sociales },
      ];
      generarPdf(res, {
